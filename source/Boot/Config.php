...
define("CONF_SITE_ADDR_STREET", "SC 406 - Rod. Dr Antônio Moura Gonzaga");
...
define("CONF_MESSAGE_SUCCESS", "success info-check-square-o");
define("CONF_MESSAGE_WARNING", "warning info-warning");
