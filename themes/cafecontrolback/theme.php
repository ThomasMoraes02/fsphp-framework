...
<head>
    <meta charset="UTF-8">
    <meta name="mit" content="2023-04-01T10:20:16-03:00+199035">
        ...
        <?php else : ?>
            <article class="footer_optout">
                <div class="footer_optout_content content">
                    ...
                    <a href="<?= url("cadastro") ?>" class="footer_optout_btn gradient gradient-green gradient-hover radius icon-check-square-o">Quero controlar</a>
                </div>
            </article>
        <?php endif; ?>
    </main>
