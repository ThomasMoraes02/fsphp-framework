    ...
    <?php if (empty($blog) && !empty($search)) : ?>
        ...
        <div class="content content">
            <div class="empty_content">
                ...
                <a href="<?= url("/blog"); ?>" title="Blog" class="empty_content_btn gradient gradient-green gradient-hover radius">...ou volte ao blog</a>
            </div>
        </div>
    <?php elseif (empty($blog)) : ?>
        <div class="content content">
            <div class="empty_content">
                <!-- <img class="empty_content_cover" title="Empty Content" alt="Empty Content"
                 src="<?= theme("/assets/images/empty-content.jpg"); ?>"/> -->
                <h3 class="empty_content_title">Ainda estamos trabalho aqui!</h3>
